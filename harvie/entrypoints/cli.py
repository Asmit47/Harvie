...
def ask_harvie(user_input: str, session_id: str | None = None) -> str:
    """Send a question to Harvie and get the final answer."""
...
def main(argv: list[str] | None = None):
    ...
    print("Harvie - type 'exit' to quit.\n")
    session_id = generate_session_id()
    ...
    while True:
        ...
        if user_input.lower() in ("exit", "quit"):
            ...
            break
        answer = ask_harvie(user_input, session_id=session_id)
        print(f"Harvie: {answer}\n")
